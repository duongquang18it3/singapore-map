...
const HitSchool = ({ hit }) => {
  ...
  const handleSelectedBoundary = useCallback(() => {
    ...
    AppStateDispatch({
      ...
      layerData: {
        layerName: "icon",
        selectedSchoolValue: hit.SEARCHVAL,
      },
    });
  ...
  console.log(appState.homeMapViewState.selectedPinned.radius);
  return (
    <div className="box has-text-left">
      <div className="is-clickable " onClick={handleSelectedBoundary}>
        <div className="columns is-vcentered is-mobile">
          <div className="is-narrow pt-1">
            <MdSchool color="hsl(348, 100%, 61%)" />
          </div>
          <div className="ml-2">
