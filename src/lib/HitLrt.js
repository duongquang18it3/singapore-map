...
const HitLrt = ({ hit }) => {
  ...
  const handleSelectedBoundaryLRT = useCallback(() => {
    ...
    AppStateDispatch({
      ...
      layerData: {
        layerName: "icon",
        selectedLRTValue: hit.SEARCHVAL,
      },
    });
    AppStateDispatch({
      type: "changePinned",
  ...
  return (
    <div className="box has-text-left">
      <div className="is-clickable " onClick={handleSelectedBoundaryLRT}>
