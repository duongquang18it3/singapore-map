...
import "./mrtMap.css";
import HitMrt from './../../../lib/HitMrt';

export const MrtMAp = (): JSX.Element => {
  const zoom = d3Zoom();
  ...
  useEffect(() => {
    mapRef && select(mapRef.current).call(
      zoom.on("zoom", (e) => {
        const trans = e.transform;
        setScale(`scale(${trans.k})`);
        setTranslate(`translate(${trans.x}, ${trans.y})`);
      }) as any
    );

    const listCircle = document.querySelectorAll("circle");

    const popup = document.querySelectorAll<HTMLElement>(".popup")[0];

    listCircle.forEach((item) => {
      item.addEventListener("click", (e) => {
        listCircle.forEach((other) => {
          other.classList.remove("active");
        });

        const stationName = getStationName(item.id);
      ...
      item.addEventListener("mouseover", (e) => {
        popup.innerHTML = getStationName(item.id);

        popup.style.display = "block";

        const popupH = popup.clientHeight;
        const popupW = popup.clientWidth / 2;

        popup.style.top = `${e.pageY - 15 - popupH - window.scrollY}px`;
        popup.style.left = `${e.pageX - popupW}px`;
      });
    ...
    const getStationName = (id: string) => {
      let textPopup = [];
      if (document.querySelectorAll(`[id="lb${id}"]`).length === 1) {
        textPopup.push(
          document.querySelectorAll(`[id="lb${id}"] > tspan`)[0]
            .textContent
        );
      } else {
        textPopup.push(
          document.querySelectorAll(`[id="lb${id}a"] > tspan`)[0]
            .textContent
        );
        textPopup.push(
          document.querySelectorAll(`[id="lb${id}b"] > tspan`)[0]
            .textContent
        );
      }
      return textPopup.join(" ");
    }
  }, []);
  ...
  return (
    <>
      ...
      <div className="modal-mrt">
        <div className="modal-dialog">
          <div className="modal-content">
            <div className="modal-header">
              <h4 className="modal-title">Search By MRT</h4>
              <p
                  ...
                  >
                    <g id="lines" fill="none" strokeWidth="4">
                      <g id="ewl" stroke="#009645">
                        ...
                        <path d="m1284 523-25 25 q-14.14 14.14-14.14 34.14 v37 q0 20 -20 20 h-220 q-20 0 -34.14 14.14 l-182 182 q-14.14 14.14-34.14 14.14 h-43 q-20 0 -34.14 -14.14 l-9-9 q-14.14-14.14-14.14-34.14 q0-20-14.14-34.14 l-230.4-230.4 q-14.14-14.14-34.14-14.14 h-280.6 q-20 0-20 20 v92" />
                      </g>
                      ...
                      <g id="tel" stroke="#784008">
                        <path d="m496 34 l147.8 147.8 q14.14 14.14 14.14 34.14 v187" />
                      </g>
                      <g id="telex" stroke="#784008" strokeDasharray="8, 8">
                        <path d="m496 34 l147.8 147.8 q14.14 14.14 14.14 34.14 v557 q0 20 14.14 34.14 l132 132 q14.14 14.14 34.14 14.14 h40 q19.25 0 48.12 -19.22 A 355 355 0 0 0 1049.23 786 q8.52 -20 19.77 -20 h297 q20 0 20 -20 v-52 q0 -20 -20 -20 h-35" />
                      </g>
                      ...
                      <g id="ftlex" stroke="#f266b5" strokeDasharray="8, 8">
                    ...
                    <g id="stns_icons" fill="#ffffff" strokeWidth="2">
                      <g id="stns_ewl" stroke="#009645">
                        <circle id="ew0" cx="1334" cy="674" r="3" />
                        ...
                        <circle id="ew23" cx="405" cy="524" r="3" />
                        ...
                        <circle id="ew33" cx="75" cy="626" r="3" />
                      </g>
                      <g id="stns_nsl" stroke="#d42e12">
                        ...
                        <circle id="ns22" cx="660" cy="586" r="3" />
                      ...
                      <g id="stns_dtl" stroke="#005ec4">
                        ...
                        <circle id="dt10" cx="658" cy="486" r="3" />
                      ...
                      <g id="stns_tel" stroke="#784008">
                        ...
                        <circle id="te21" cx="846" cy="953" r="3" />
                        <circle id="te22" cx="901" cy="948" r="3" />
                        <circle id="te31" cx="951" cy="915" r="3" />
                      ...
                      <g id="stns_jrl" stroke="#0099aa">
                        ...
                        <circle id="je7" cx="346" cy="574" r="3" />
                      ...
                      <g id="stns_crl" stroke="#78BE20">
                        ...
                        <circle id="cr1" cx="1258" cy="420" r="3" />
                      </g>
                      <g id="stns_ints" stroke="#000000" strokeWidth="3">
                      ...
                      <g id="stns_bplrt" stroke="#999999" strokeWidth="1.7">
                      ...
                      <g id="stns_sklrt" stroke="#999999" strokeWidth="1.7">
                      ...
                      <g id="stns_pglrt" stroke="#999999" strokeWidth="1.7">
                      ...
                      <g id="stns_rtslink" stroke="#87cefa" strokeWidth="1.7">
                    ...
                    <g id="stns_labels" fontFamily="Arial">
                      <g id="lbewl" fontSize="12" fill="#000000">
                        <switch>
                          <text id="lbew0a" x="1310" y="687">
                            <tspan id="trsvg61">Changi</tspan>
                          </text>
                        </switch>
                        <switch>
                          <text id="lbew0b" x="1312" y="699">
                      ...
                      <g id="lbtelex" fontSize="12" fill="#aaaaaa">
                        ...
                        <switch>
                          <text id="lbte21a" x="828" y="968">
                            <tspan id="trsvg230">Marina</tspan>
                          </text>
                        </switch>
                        <switch>
                          <text id="lbte21b" x="830" y="980">
                      ...
                      <g id="lbjrlex" fontSize="12" fill="#aaaaaa">
                        ...
                        <switch>
                          <text id="lbje7a" x="297" y="582">
                            <tspan id="trsvg271">Pandan</tspan>
                          </text>
                        </switch>
                        <switch>
                          <text id="lbje7b" x="288" y="594">
                      ...
                      <g id="lbpgl" fontSize="10" fill="#000000">
                        ...
                        <switch>
                          <text id="lbpw2" x="1162" y="150" fill="#aaaaaa">
            ...
            <div className="modal-footer">
              <p
                className="btn-reset-mrt"
                onClick={handleClearStation}
              >Clear</p>
              <p
                className="btn-search-mrt"
                onClick={handleSearchStation}
              >Search</p>
            </div>
          </div>
        </div>
        <div className="modal-backdrop" onClick={handleTogglePopUp}></div>
      </div>
    </>
  );
};
